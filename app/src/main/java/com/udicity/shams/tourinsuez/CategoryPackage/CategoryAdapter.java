...
public class CategoryAdapter extends ArrayAdapter<Category> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView categoryTextView = categoriesListItemView.findViewById(R.id.category_text_view);
        categoryTextView.setText(currentCategory.getmCategoryName());
        ImageView categoryImageView = categoriesListItemView.findViewById(R.id.category_image_icon_view);
